 ...
 * Owned by the chat domain (chat/services/) — this service manages the chat
 * wire protocol, not generic app infrastructure.
 *
 ...
 *
 * @module chat/services/socket.service
 */

import { getSocketClient, type AppSocket } from '@/chat/lib/socket-client';
import type {
  Message,
  ChatUser,
  UserColor,
} from '@/chat/dtos/chat.dto';
